...
public class Final {
    public static void main(String[] args) throws ParseException, IOException {
        FileInputStream fis = new FileInputStream("src/main/resources/properties/env/accp/Config.properties");
        Properties prop = new Properties();
        prop.load(fis);
        // Specify the folder containing the zip files
        String folderPath = prop.getProperty("test_files_source_url_ACCP");
        // Specify the path for the Excel file
        String excelFilePath = prop.getProperty("test_files_excel_destination_url_accp");
        //String excelFilePath = "C:\\Documents\\SFDC Retirement\\Copy Table Automation\\New folder\\SFDC_COPY_TABLE_COUNT.xlsx";
        // Specify the path for the CSV file
        String csvFilePath = prop.getProperty("test_files_csv_destination_url_accp");
       // String csvFilePath = "C:\\Documents\\SFDC Retirement\\Copy Table Automation\\New folder\\SFDC_COPY_TABLE_COUNT.csv";
            ...
            try (Workbook workbook = new XSSFWorkbook()) {
                ...
                for (File zipFile : zipFiles) {
                    ...
                    try (ZipInputStream zis = new ZipInputStream(new FileInputStream(zipFile))) {
                        ...
                        String output = zipFile.getName();
                        System.out.println(output);

                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    /*PrintStream myconsole = new PrintStream(new File("C:\\Users\\i728890\\Project\\src\\main\\resources\\console output\\consolefile.txt"));
                    System.setOut(myconsole);
                    myconsole.print(output);
*/
                }
                /*PrintStream myconsole = new PrintStream(new File("C:\\Users\\i728890\\Project\\src\\main\\resources\\console output\\consolefile.txt"));
                System.setOut(myconsole);
                myconsole.print("Unzipped and processed logs: " + zipFile.getName());*/
