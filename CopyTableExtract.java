private BalanceHistoryCache(final ParticipantKey key) {
    ...
    if (startDate == null && endDate == null) {
        ...
        try {
            boolean bridgeAppEnabled = isBridgeAppEnabled();
            if (bridgeAppEnabled) {
                fetchBalanceHistoryFromBridgeApp(key);
            } else {
...
private boolean isBridgeAppEnabled() {
    return Boolean.parseBoolean(System.getProperty("ppt.bridgeapp.enabled", "false"));
}

private void fetchBalanceHistoryFromBridgeApp(ParticipantKey key) throws BusinessException {
    ...
    boolean bridgeAppEnabledKey = isBridgeAppEnabled();
